...
- Keep Architecture B3, Architecture B4, Atomic B4, Policy Vault, Provider A, Provider B, and Other Infrastructure as distinct sibling sections. Do not merge a verdict heading or its labelled facts into the preceding paragraph.
